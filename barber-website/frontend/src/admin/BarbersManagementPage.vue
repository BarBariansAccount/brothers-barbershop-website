<template>
    <v-container>
        <v-row>
            <v-col lg="3" md="4" sm="6" xs="12" justify="space-around" v-for="item in barbers" :key="item.index"
                class="pa-10 mb-5">
                <v-card width="300" class="">
                    <v-img height="300px" src="../assets/black.jpeg">
                        ...
                        <v-card-title class="white--text" style="margin-right: auto; margin-left: auto">

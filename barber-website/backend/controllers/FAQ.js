...
const updateFAQ = async (req, res) => {
    ...
    try {
        ...
        await pool.query(faqModel.updateFAQ, [faqid, question, answer])//error
...
const deleteFAQ = async (req, res) => {
    ...
    try {
        ...
        await pool.query(faqModel.deleteFAQ, [faqid]);
...
const addFAQ = async (req, res) => {
    ...
    try {
        ...
        await pool.query(faqModel.addFAQ, [question, answer])
